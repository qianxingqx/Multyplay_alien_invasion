...
class Scoreboard():
	...
	def prep_high_score(self):
		...
		self.high_score_image = self.font.render('Best Score: '+high_score_str, True, self.text_color, self.ai_settings.bg_color)
	...
	def prep_level(self):
		# 显示等级
		self.level_image = self.font2.render('Level:'+str(self.stats.level), True, self.text_color, self.ai_settings.bg_color)
